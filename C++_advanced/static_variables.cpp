	...
	int main()								//main function
	{
        ...
        cout<<"\nstatic var sum o1: "<<o1.sum;		//value of sum for object o2 of class statex
		cout<<"\nstatic var sum o2: "<<o2.sum;		//value of sum for object o2 of class statex		
		
		statex o4;							//decaling another object o4 of class statex
		cout<<"\nstatic var sum o4: "<<o4.sum;		//value of sum for object o2 of class statex
